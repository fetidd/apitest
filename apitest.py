...
def create_tests(path):
    cprint("dark_gray", "getting tests from {}... ".format(path), end="")
...
def run_tests(tests):
    ...
    for section_name, tests in tests:
        if not tests:
            continue
        subheader(section_name, "dark_gray")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--file", action="store", default="./testBuild")
    parser.add_argument("--verbose", action="store_true", default=False)
    parser.add_argument("--test_path", action="store", default="./acceptance/tests.yaml")
